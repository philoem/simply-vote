          ...
          <div className="card card-side bg-base-100 shadow-xl" key={index}>
            <figure>
              <div className='flex flex-col'>
                <img src={vote.link1} alt="Movie" className='w-[160px] md:w-full h-[135px] rounded-[22px] mb-3 object-cover pt-[10px] pl-[10px]'/>
                <img src={vote.link2} alt="Movie" className='w-[160px] md:w-full h-[135px] rounded-[22px] mb-3 object-cover pt-[10px] pl-[10px]'/>
              </div>
            </figure>
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <button onClick={() => getDetails(vote.id)} className="btn btn-primary">Voir les détails</button>
              </div>
            </div>
          </div>
        ))}
